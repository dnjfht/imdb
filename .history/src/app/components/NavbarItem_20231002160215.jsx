  ...
  return (
    <div>
      <Link
        className={`${
          genre && genre === param
            ? "underline underline-offset-8 decoration-4 decoration-emerald-950 text-emerald-950 rounded-lg"
            : "text-gray-400 dark:text-white"
        }
        m-4 hover:text-emerald-950 dark:hover:text-emerald-950 font-semibold p-2 transition-colors duration-700`}
        href={`/?genre=${param}`}
      >
        {title}
      </Link>
