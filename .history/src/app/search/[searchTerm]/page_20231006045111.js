...
export default async function SearchPage(props) {
  ...
  const res = await fetch(
    `https://api.themoviedb.org/3/search/movie?api_key=${process.env.NEXT_PUBLIC_API_KEY}&query=${props.params.searchTerm}&language=en-US&page=1&include_adult=false`
  );
